export const CHARACTERS = {
  park:   { name: "Deputy Mayor Dana Park",       role: "Your Chief of Staff",                      color: "#1C2B4A" },
  hochul: { name: "Governor Kathy Hochul",        role: "State of New York",                        color: "#8B1A1A",  avatar: "/avatars/hochul.png" },
